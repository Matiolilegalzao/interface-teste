        ...
        <ul className={styles.sideBarList}>
            ...
            <Link to="/">
                <li className={styles.sideBarListItem}>
                    ...
                    <span className={styles.itemText}>Página inicial</span>
                </li>
            </Link>
            </div>
            ...
            <Link to="/meus-documentos">
                <li className={styles.sideBarListItem}>
                    ...
                    <span className={styles.itemText}>Documentos e dados</span>
                </li>
            </Link>
            <Link to="/settings">
      <li className={styles.sideBarListItem}>
        <FaCog size={28} />
        <span className={styles.itemText}>Configurações</span>
      </li>
    </Link>
    <li className={styles.logoutBtn} style={{ position: 'fixed', bottom: '0' }}>
